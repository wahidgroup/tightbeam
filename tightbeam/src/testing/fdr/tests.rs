...
fn test_fdr_integration_with_tb_scenario() {
	...
	crate::tb_assert_spec! {
		...
		V(1,0,0): {
			...
			gate: Accepted,
			assertions: [
				(HandlerStart, "pointA", crate::exactly!(2)),
				(HandlerStart, "pointB", crate::exactly!(1))
			]
		},
	}
	...
	crate::tb_scenario! {
		...
		environment Bare {
			exec: |trace| {
				...
				trace.assert(crate::testing::assertions::AssertionPhase::HandlerStart, "pointA");
				trace.assert(crate::testing::assertions::AssertionPhase::HandlerStart, "pointA");
				trace.assert(crate::testing::assertions::AssertionPhase::HandlerStart, "pointB");
				Ok(())
			}
		}
	}
